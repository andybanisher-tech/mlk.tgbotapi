<?php
$MESS['MLK_TGBOTAPI_TAB_HL'] = 'Highload-блок';
$MESS['MLK_TGBOTAPI_TAB_HL_TITLE'] = 'Настройки Highload-блока с контрагентами';
$MESS['MLK_TGBOTAPI_TAB_IBLOCKS'] = 'Инфоблоки';
$MESS['MLK_TGBOTAPI_TAB_IBLOCKS_TITLE'] = 'Настройка инфоблоков с баннерами';
$MESS['MLK_TGBOTAPI_TAB_API'] = 'API ключ';
$MESS['MLK_TGBOTAPI_TAB_API_TITLE'] = 'Настройки API';

$MESS['MLK_TGBOTAPI_HL_ID'] = 'Highload-блок';
$MESS['MLK_TGBOTAPI_SELECT_HL'] = '- выбрать HL-блок -';
...
$MESS['MLK_TGBOTAPI_IBLOCK_ITEM'] = 'Инфоблок';
$MESS['MLK_TGBOTAPI_IBLOCK_ID'] = 'Инфоблок';
$MESS['MLK_TGBOTAPI_PROPERTY_GROUP_ID'] = 'Свойство с группами';
$MESS['MLK_TGBOTAPI_SELECT_PROPERTY'] = '- выбрать свойство -';
$MESS['MLK_TGBOTAPI_FIELD_NAME'] = 'Поле для имени';
$MESS['MLK_TGBOTAPI_FIELD_DESCRIPTION'] = 'Поле для описания';
$MESS['MLK_TGBOTAPI_FIELD_IMAGE'] = 'Поле для картинки';
$MESS['MLK_TGBOTAPI_FIELD_LINK'] = 'Поле для ссылки';
...
$MESS['MLK_TGBOTAPI_API_URL'] = 'URL для запросов (пример)';
?>
